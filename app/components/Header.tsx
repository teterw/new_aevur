  ...
  return (
    ...
    >
      ...
      <div className="flex gap-5 items-center">
        <Link
          href="/dashboard"
          className={`px-5 py-2 rounded-full font-medium transition-all duration-300 hover:-translate-y-0.5 ${
            theme === 'dark'
        ...
        <Link
          ...
          className={`px-5 py-2 rounded-full font-bold transition-all duration-300 ${
            theme === 'dark'
              ? 'bg-linear-to-br from-gray-600 to-gray-500 text-green-400'
